...
- [Dia 1: Indeksointi](#dia-1-indeksointi)
- [Dia 2: Indeksointiesimerkki](#dia-2-indeksointiesimerkki)
- [Dia 3: Indeksin luonti](#dia-3-indeksin-luonti)
- [Dia 4: Clustered / Non-clustered / Paksu indeksit](#dia-4-clustered--non-clustered--paksu-indeksit)
- [Dia 5: Transaktiot - ACID](#dia-5-transaktiot---acid)
- [Dia 6: Transaktion / tapahtuman hallinta](#dia-6-transaktion--tapahtuman-hallinta)
- [Dia 7: Esimerkit](#dia-7-esimerkit)
- [Dia 8: Milloin ja miten käyttää indeksejä?](#dia-8-milloin-ja-miten-käyttää-indeksejä)
- [Dia 9: ACID](#dia-9-acid)
...
- Juurisolmu: 3180 (jakaa haarat)
- Vasen haara: 1950-3165
- Oikea haara: 4604.60-5300.00
- Lehtisolmut sisältävät palkka-arvot järjestyksessä

**Hakualgoritmi (palkka 4600-4700):**

1. Vertaa 3180 → oikea haara
2. Vertaa 4604.60 → löytyi!
3. Lue lehtisolmu → 4604.60 ja 4699.76
4. Siirry suoraan tietueisiin osoitteiden kautta
...
**KÄSITE**
Joukko tietokannan käsittelytoimenpiteitä (kyselyjä, lisäyksiä, muutoksia, poistoja), jotka muodostavat loogisen kokonaisuuden.
...
- **A**tomicity / Jakamattomuus, atomisuus
- **C**onsistency / Eheys, oikeellisuus
- **I**solation / Erillisyys, eristyvyys
- **D**urability / Pysyvyys
